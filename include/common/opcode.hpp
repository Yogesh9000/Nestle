...
constexpr std::array<Opcode, NUM_OPCODES> opcodes{{
    {"BRK", 1, 7, false, AddressingMode::Implicit, false},
    {"ORA", 2, 6, false, AddressingMode::IndexedIndirect, false},
    {"JAM", 1, -1, false, AddressingMode::Implicit, true},
    ...
    {"PHP", 1, 3, false, AddressingMode::Implicit, false},
    ...
    {"CLC", 1, 2, false, AddressingMode::Implicit, false},
    {"ORA", 3, 4, true, AddressingMode::AbsoluteY, false},
    {"NOP", 1, 2, false, AddressingMode::Implicit, true},
    ...
    {"PLP", 1, 4, false, AddressingMode::Implicit, false},
    ...
    {"SEC", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"RTI", 1, 6, false, AddressingMode::Implicit, false},
    ...
    {"PHA", 1, 3, false, AddressingMode::Implicit, false},
    ...
    {"CLI", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"RTS", 1, 6, false, AddressingMode::Implicit, false},
    ...
    {"PLA", 1, 4, false, AddressingMode::Implicit, false},
    ...
    {"SEI", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"DEY", 1, 2, false, AddressingMode::Implicit, false},
    {"NOP", 2, 2, false, AddressingMode::Immediate, true},
    {"TXA", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"TYA", 1, 2, false, AddressingMode::Implicit, false},
    {"STA", 3, 5, false, AddressingMode::AbsoluteY, false},
    {"TXS", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"TAY", 1, 2, false, AddressingMode::Implicit, false},
    {"LDA", 2, 2, false, AddressingMode::Immediate, false},
    {"TAX", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"CLV", 1, 2, false, AddressingMode::Implicit, false},
    {"LDA", 3, 4, true, AddressingMode::AbsoluteY, false},
    {"TSX", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"INY", 1, 2, false, AddressingMode::Implicit, false},
    {"CMP", 2, 2, false, AddressingMode::Immediate, false},
    {"DEX", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"CLD", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"INX", 1, 2, false, AddressingMode::Implicit, false},
    {"SBC", 2, 2, false, AddressingMode::Immediate, false},
    {"NOP", 1, 2, false, AddressingMode::Implicit, false},
    ...
    {"SED", 1, 2, false, AddressingMode::Implicit, false},
